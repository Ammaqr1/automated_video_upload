...
"""
import os 
from image_magick import image_magick_path

FFMPEG_BINARY = os.getenv('FFMPEG_BINARY', 'ffmpeg-imageio')
full_path = os.path.abspath(image_magick_path.image_magick_cwd())
IMAGEMAGICK_BINARY = os.path.join(full_path,"magick.exe")
